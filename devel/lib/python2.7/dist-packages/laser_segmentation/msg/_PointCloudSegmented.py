...
"""autogenerated by genpy from laser_segmentation/PointCloudSegmented.msg. Do not edit."""
import sys
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','laser_segmentation/Segment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointCloudSegmented, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = laser_segmentation.msg.Segment()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.points = []
